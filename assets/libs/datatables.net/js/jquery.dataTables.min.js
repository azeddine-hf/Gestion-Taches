...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Première",sLast:"Dernière",sNext:"suivant",sPrevious:"Précédent"},sEmptyTable:"aucune donnée disponible ",sInfo:"lines _START_ to _END_ of _TOTAL_ entries",sInfoEmpty:"lines 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"lignes _MENU_ ",sLoadingRecords:"Chargement...",sProcessing:"Traitement...",sSearch:"Chercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrements correspondants trouvés"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,
