...
$qury = "SELECT  c.*, e.* from equipe e , chat_contact c where is_deleted=0 and e.Email != '$email2' and ((c.Sender_email='$email2' and c.Destination_email=e.Email) or (c.Destination_email='$email2' and c.Sender_email=e.Email)) AND last_msg=Message order by c.send_date desc,c.Message,c.last_msg";
